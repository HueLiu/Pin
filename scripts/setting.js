    ...
    views: [{
      ...
      },
      {
        ...
        layout: (make, view) => {
          ...
          _view.$setIncrementImage_forState(_view.$incrementImageForState(0), 0);
          _view.$setDecrementImage_forState(_view.$decrementImageForState(0), 0);
        },
        events: {
          changed: sender => {
